          ...
          >
            <div className="flex flex-col gap-6">
              <div className="flex items-center justify-start gap-4 px-4">
                ...
                <span className="text-base font-bold text-white text-left">Click the button below</span>
              </div>
              <div className="flex items-center justify-start gap-4 px-4">
                <CheckCircle2 className="w-8 h-8 text-white flex-shrink-0" />
                <span className="text-base font-bold text-white text-left">Verify your email</span>
              </div>
              <div className="flex items-center justify-start gap-4 px-4">
                <CheckCircle2 className="w-8 h-8 text-white flex-shrink-0" />
                <span className="text-base font-bold text-white text-left">Complete 3–5 offers</span>
              </div>
              <div className="flex items-center justify-start gap-4 px-4">
                <CheckCircle2 className="w-8 h-8 text-white flex-shrink-0" />
                <span className="text-base font-bold text-white text-left">Cash out same day!</span>
              </div>
            </div>
          </div>
